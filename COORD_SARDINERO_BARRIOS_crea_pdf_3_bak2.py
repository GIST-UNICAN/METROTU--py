...
def genera_informe(
    ...
    def comprueba_llegada_intercambiador(num_parada_interc,
        ...
        return (parada == num_parada_interc and
                (num_parada_interc != linea_anterior[cols.parada]
...
##            if linea==100:
                ...
                if comprueba_llegada_valdecilla(17):
...
##                        resultados["Barrios_Sardinero"]))
    ...
    def genera_tablas_intercambiador(trayecto,
        ...
        def comprueba_media_mas_50_porciento(row):
            return 1 if row['espera']>1*table_intercambiador_barrios_espera[
