        ...
        for raw_row in iter_archivo:
            try:
                ...
                row[7] = datetime.strptime(
                    str(row[5]), "%Y-%m-%d %H:%M:%S").replace(hour=0, minute=0, second=0)
                # insertamos en la bd
...
filtra_excel(
    r"D:\Users\Andres\OneDrive\OneDrive - Universidad de Cantabria\Recordar GIST - VARIOS\datos_tus\abrilpp.rpt"
)
