...
inner join (Select * from pasos_parada_ajustada where linea=20 and parada =511 and Instante between @fecha_ini and @fecha_fin) ppa
...
directorio = "informe_l20_medias_llegadas_de_{}{}{}_a_{}{}{}\\".format(dia_inicio.year,
                                                                      dia_inicio.month,
                                                                      dia_inicio.day,
                                                                      dia_fin.year,
                                                                      dia_fin.month,
...
for cabecera, elementos in diccionario_dia_viajes.items():
    ...
    for grupo_horario, elementos1 in elementos.items():
        ...
        titulo = 'Llegadas L. 20 a la cabecera {}'.format(cabecera_nombre)
...
cwd = os.getcwd()
pivot_table.to_csv(
    path_or_buf=cwd + R"\20-CSV-DESVIO\{}{}{}_a_{}{}{}.csv".format(dia_inicio.year,
                                                                        dia_inicio.month,
                                                                        dia_inicio.day,
                                                                        dia_fin.year,
                                                                        dia_fin.month,
...
with open(directorio + 'informe.html', 'w') as file:
    texto = textos_html_informe_100.plantilla_web_estilos + textos_html_informe_100.plantilla_web_cuerpo.format(
    ...
    texto = texto.replace('CENTRAL', '20')
    print(texto, file=file)
create_pdf(
    directorio + 'informe.html',
    directorio + 'linea_20_desvios_del_{}-{}-{}_al_{}-{}-{}.pdf'.format(dia_inicio.year,
                                                                       dia_inicio.month,
                                                                       dia_inicio.day,
                                                                       dia_fin.year,
                                                                       dia_fin.month,
