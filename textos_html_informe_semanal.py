...
<p class=MsoNormal><u><span style='font-size:12.0pt;line-height:106%'>Gráfico variación semanal:</span></u></p>

<div class=imagen><img align="middle", src="{grafico}.png"></div>
...
style='font-size:16.0pt;line-height:106%'>INFORME SEMANA {dia_inicio} de {mes_inicio} al {dia_fin} de {mes_fin}</span></p>
