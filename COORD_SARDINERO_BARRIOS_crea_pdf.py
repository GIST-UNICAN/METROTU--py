...
actual_aux=datetime.now()
##actual_aux=actual-timedelta(days=1)
lista_dias=(actual_aux-timedelta(days=day) for day in range(1,2) )
for actual in lista_dias:
    directorio="{}{}{}/".format(actual.year,actual.month,actual.day-dia_resta)
    if os.path.exists(directorio):
        pass
    else:
        os.mkdir("{}{}{}".format(actual.year,actual.month,actual.day-dia_resta))
    ...
    class Comprobador():
        ...
        def datetime2datetimegist(dt):
            return datetime_gist(dt.year,dt.month,t.day,dt.hour,dt.minute,dt.second,dt.microsecond)
    ...
    ##        if self.linea==100:
    ##            print(' salida: ',salida, ' salida row anterior: ',salida_row_anterior,' diferencia: ',diferencia,' horario considerado '
    ...
    ##            print('check p insercion tipo', type(salida-self.tiempo_hasta_parada_control), ' resta ', salida-self.tiempo_hasta_parada_control)
    ##            print('---------------------------------------')
    ...
    ##    fecha_fin=datetime(actual.year,actual.month,actual.day-dia_resta,22,0,0)  #########################################
        ...
        query = ("SELECT * FROM `pasos_parada` where Instante between '{0}' and '{1}' "
                 "and ({2}) "
        ...
        with open(directorio+'informe{}{}{}.html'.format(actual.year,actual.month,actual.day-dia_resta),'w') as file:
            print(texto_exportar, file=file)

        create_pdf(
            directorio+'informe{}{}{}.html'.format(actual.year,actual.month,actual.day-dia_resta),
            directorio+'informe{}{}{}.pdf'.format(actual.year,actual.month,actual.day-dia_resta)
            )
