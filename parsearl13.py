...
ws1 = wb.active
ws3 = wb.create_sheet(title="tv lluja valdecilla")
ws4 = wb.create_sheet(title="tv valdecilla lluja")
...
for vehiculo in conjunto_vehiculos:
    ...
    for row in itera_vehiculo(vehiculo):
        if row[3].value==509 and fila_anterior[3].value==445:
            t1=row[5].value
        ...
        if row[3].value==445 and fila_anterior[3].value==512:
            t1=row[5].value
            t2=fila_anterior[5].value
            dt1 = timedelta(hours=t1.hour, minutes=t1.minute, seconds=t1.second)
            dt2 = timedelta(hours=t2.hour, minutes=t2.minute, seconds=t2.second)
